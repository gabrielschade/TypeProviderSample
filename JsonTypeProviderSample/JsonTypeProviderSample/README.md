...
Assim como vimos com o [provider para html](https://github.com/gabrielschade/TypeProviderSample/tree/master/HtmlTypeProviderSample), também é possível criar um tipo a partir de um JSON.

Primeiro vamos escolher quais dados serão obtidos para o teste. 
Como sugestão, proponho utilizar a API pública do GitHub, mas você pode utilizar qualquer outra URL que os passos para realizar a busca dos dados são os mesmos.
